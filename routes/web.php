...
use App\Http\Controllers\Admin\MayController;
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['auth']], function () {
    ...
    // May
    Route::post('mays/csv', [MayController::class, 'csvStore'])->name('mays.csv.store');
    Route::put('mays/csv', [MayController::class, 'csvUpdate'])->name('mays.csv.update');
    Route::resource('mays', MayController::class, ['except' => ['store', 'update', 'destroy']]);
